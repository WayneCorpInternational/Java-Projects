create database db_frutinha_do_tio;

use db_frutinha_do_tio;

CREATE TABLE `tb_caracteristicas` ( -- criado tabela ( caracteristicas das frutas )
...
CREATE TABLE `tb_frutas` (  -- as frutas em sim 
	`id` bigint NOT NULL AUTO_INCREMENT,
	`nome` varchar(255) NOT NULL, -- tudo tem que ter um  nome
	`preco` DECIMAL(10,2) NOT NULL, -- tudo tem que ter um preco
	`fk_id_caracteristicas` bigint NOT NULL, -- criado uma noa variavel, que eh uma chave estrangeira
	PRIMARY KEY (`id`),
